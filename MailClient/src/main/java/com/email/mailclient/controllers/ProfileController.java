...
private void loadEdit1(){
    try {
        ...
        loader.setControllerFactory(c -> new Edit1Controller(config, socket, emailAddress, loginResponse));
    ...
    private void loadEdit2(){
        try {
            ...
            loader.setControllerFactory(c -> new Edit2Controller(config, socket, emailAddress, loginResponse));
            Parent root = loader.load();
