...
public class SettingController extends CommonController implements Initializable {
    ...
    private void showProfile() {
            ...
            try {
                ...
                loader.setControllerFactory(c -> new ProfileController (config, socket, emailAddress,loginResponse ));
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        txtEmailAddress.setText(emailAddress+config.getProperty("default.domain"));

    }

    public SettingController(Properties config, Socket socket, String emailAddress, String loginResponse) {
       this.config = config;
        this.socket = socket;
